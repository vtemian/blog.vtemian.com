...
date: 2026-03-28
author: Vlad Temian
url: https://blog.vtemian.com/post/harness-engineering/
...
tags: [ai, agentic-programming, deep-dive]
---

# Harness Engineering: Why Your AI Coding Setup Matters More Than the Model
...
- [gitfs](https://github.com/vtemian/gitfs/blob/main/CLAUDE.md): CLAUDE.md retrofitted onto a 10-year-old Python project
- [django-server-timing](https://github.com/vtemian/django-server-timing/blob/main/CLAUDE.md): same pattern on an established Django library
